/**
 * Deno HTTP server entrypoint for the ChatKit starter backend.
 */

import { StreamingResult } from "chatkit-server";
import { StarterChatServer } from "./server.ts";

const PORT = parseInt(Deno.env.get("PORT") || "8000", 10);

const chatKitServer = new StarterChatServer();
...
console.log(`ChatKit Starter JS Backend running on http://localhost:${PORT}`);
