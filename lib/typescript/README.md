...
- **Library Components**: `agent.py`, `environment.py`, `loop.py`, `responses_api.py`
- **Examples**: `scripts/personal_assistant_app.py`, `scripts/weather_assistant_app.py`
- **Features**: Built-in handoff tool, conditional tool registration, ResponsesAPI component

## Future Implementation

When implementing the TypeScript version:

1. Use the same four core entities: Agent, Environment, Loop, ResponsesAPI
...
7. Provide ResponsesAPI component for `/v1/responses` endpoint
