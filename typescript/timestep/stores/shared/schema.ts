...
export async function initializeSchema(db: any): Promise<void> {
  ...
  `);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_agent_tools_agent_id ON agent_tools(agent_id)`);
  ...
  `);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_agent_guardrails_agent_id ON agent_guardrails(agent_id)`);
  ...
  `);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_agent_handoffs_agent_id ON agent_handoffs(agent_id)`);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_agent_handoffs_handoff_agent_id ON agent_handoffs(handoff_agent_id)`);
  ...
  `);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_agent_mcp_servers_agent_id ON agent_mcp_servers(agent_id)`);
  ...
  `);
  await db.query(`CREATE INDEX IF NOT EXISTS idx_sessions_session_id ON sessions(session_id)`);
}
