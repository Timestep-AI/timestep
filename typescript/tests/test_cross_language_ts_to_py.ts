...
test.each([["gpt-4.1"], ["ollama/gpt-oss:20b-cloud"], ["ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M"], ["openai/gpt-5.2"]])('test_cross_language_ts_to_py_blocking_non_streaming with %s', async (model) => {
...
test.each([["gpt-4.1"], ["ollama/gpt-oss:20b-cloud"], ["ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M"], ["openai/gpt-5.2"]])('test_cross_language_ts_to_py_blocking_streaming with %s', async (model) => {
  if (model === "ollama/gpt-oss:20b-cloud" || model === "ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M") {
...
test.each([["gpt-4.1"], ["ollama/gpt-oss:20b-cloud"], ["ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M"], ["openai/gpt-5.2"]])('test_cross_language_ts_to_py_parallel_non_streaming with %s', async (model) => {
  if (model === "ollama/gpt-oss:20b-cloud" || model === "ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M") {
    // Expected failure: Ollama cloud model has known compatibility issues
    try {
...
test.each([["gpt-4.1"], ["ollama/gpt-oss:20b-cloud"], ["ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M"], ["openai/gpt-5.2"]])('test_cross_language_ts_to_py_parallel_streaming with %s', async (model) => {
  if (model === "ollama/gpt-oss:20b-cloud" || model === "ollama/hf.co/mjschock/SmolVLM2-500M-Video-Instruct-GGUF:Q4_K_M") {
    // Expected failure: Ollama cloud model has known compatibility issues
    try {
